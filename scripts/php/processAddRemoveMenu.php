...
/// --------------- on the top
$matchPos = strpos($file_contents, "let menuHeight = ");
$matchPos2 = strpos($file_contents, "*", $matchPos);
$matchPos3 = strpos($file_contents, ";", $matchPos2);
$menuHeightInit1=substr($file_contents, $matchPos+strlen("let menuHeight = "), $matchPos2-$matchPos-strlen("let menuHeight = "));
$menuHeightInit2=substr($file_contents, $matchPos+strlen("let menuHeight = ")+strlen($menuHeightInit1)+1, $matchPos3-$matchPos2-1);
...
if ($matchPos!==false) {
	...
	$file_contents=substr($file_contents, 0, $matchPos)."let menuHeight = ".$menuHeightInt1."*".$menuHeightInt2_new.substr($file_contents, $matchPos3);
}
