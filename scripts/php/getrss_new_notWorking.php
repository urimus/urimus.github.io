...
if($q=="top_bbc") { $link="https://www.bbc.com/news"; $gtitle="BBC News - Home"; }
elseif($q=="world_bbc") { $link="https://www.bbc.com/news/world"; $gtitle="BBC News - World"; }
elseif($q=="uk_bbc") { $link="https://www.bbc.com/news/uk"; $gtitle="BBC News - UK"; }
elseif($q=="business_bbc") { $link="https://www.bbc.com/news/business"; $gtitle="BBC News - Business"; }
elseif($q=="politics_bbc") { $link="https://www.bbc.com/news"; $gtitle="BBC News - UK Politics"; }
elseif($q=="health_bbc") { $link="https://www.bbc.com/news/health"; $gtitle="BBC News - Health"; }
elseif($q=="education_bbc") { $link="https://www.bbc.com/news/science_and_environment"; $gtitle="BBC News - Family & Education"; }
elseif($q=="science_bbc") { $link="https://www.bbc.com/news/science_and_environment"; $gtitle="BBC News - Science & Environment"; }
elseif($q=="technology_bbc") { $link="https://www.bbc.com/news/technology"; $gtitle="BBC News - Technology"; }
elseif($q=="entertainment_bbc") { $link="https://www.bbc.com/news/entertainment_and_arts"; $gtitle="BBC News - Entertainment & Arts"; }
elseif($q=="russian_bbc") { $link="https://www.bbc.com/russian/news"; $gtitle="BBC News - Русская Служба"; }

elseif($q=="lenta") { $link="https://lenta.ru/rss/news"; }
...
if ($postfix=="_bbc") {
    ...
    $xml=$xml."\n        <title><![CDATA[".$gtitle."]]></title>";
    $xml=$xml."\n        <description><![CDATA[".$gtitle."]]></description>";
    $xml=$xml."\n        <link>".$link."</link>";
    $xml=$xml."\n        <image>";
    ...
    $recordsNum=substr_count($html,"<div class=\"eagle-item__body\">");

    
    $xml=$xml."\n        <ttl>".$recordsNum."</ttl>";
    
    $matchPos1=strpos($html , "<div class=\"eagle-item faux-block-link\" >");
    for ($i=0;$i<$recordsNum;$i++){
        ...
        // descripttion
        $matchPos4=strpos($html, "<p class=\"eagle-item__summary\">", $matchPos3+1);
        $matchPos5=strpos($html, "</p>", $matchPos4+1);
        $description=substr($html, $matchPos4+strlen("<p class=\"eagle-item__summary\">"), $matchPos5-$matchPos4-strlen("<p class=\"eagle-item__summary\">"));
        ...
        // next cycle
        $matchPos1=strpos($html , "<div class=\"eagle-item faux-block-link\" >", $matchPos1+1);
