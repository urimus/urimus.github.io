...
function addTableRow(tableSM, menu, key, lang, type, newTableId) {
	...
	if (type != "contentsLink") {
		divSM.setAttribute('style', 'border-spacing: 0px; padding-left:5px; padding-right:5px;');
	} else {
		if (!isImage) {
...
function showSubMenu(ele, lang, type, newTableId) {
	...
	if (lastSubMenu==null) {
		...
		tableStyle += " max-width: 280px; opacity:0; transition: opacity 0.2s linear;";
