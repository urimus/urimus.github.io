...
if (lang=="eng") {
	...
	wholeMenu["HTML Editor"].link = "html_editor_eng.html?pattern=spec/mo*&i=0";
...
if (lang=="rus") {
	...
	wholeMenu["HTML Редактор"].link = "html_editor_rus.html?pattern=spec/mo*&i=0";
...
if (lang=="eng") {
	...
	wholeMenu["● BBC RSS Feed"].hasSub = 1;
	wholeMenu["● BBC RSS Feed"].link = "";
	wholeMenu["● BBC RSS Feed"].html = '&#9679; BBC RSS Feed';

	wholeMenu["BBC RSS Feed Top"] = {};
	wholeMenu["BBC RSS Feed Top"].id = "26_1_1";
	wholeMenu["BBC RSS Feed Top"].color = "red";
	wholeMenu["BBC RSS Feed Top"].hasSub = 0;
	wholeMenu["BBC RSS Feed Top"].link = "news_bbc_eng.html?type=top";
	wholeMenu["BBC RSS Feed Top"].html = 'Top';

	wholeMenu["BBC RSS Feed World"] = {};
	wholeMenu["BBC RSS Feed World"].id = "26_1_2";
	wholeMenu["BBC RSS Feed World"].color = "red";
	wholeMenu["BBC RSS Feed World"].hasSub = 0;
	wholeMenu["BBC RSS Feed World"].link = "news_bbc_eng.html?type=world";
	wholeMenu["BBC RSS Feed World"].html = 'World';

	wholeMenu["BBC RSS Feed UK"] = {};
	wholeMenu["BBC RSS Feed UK"].id = "26_1_3";
	wholeMenu["BBC RSS Feed UK"].color = "red";
	wholeMenu["BBC RSS Feed UK"].hasSub = 0;
	wholeMenu["BBC RSS Feed UK"].link = "news_bbc_eng.html?type=uk";
	wholeMenu["BBC RSS Feed UK"].html = 'UK';

	wholeMenu["BBC RSS Feed Business"] = {};
	wholeMenu["BBC RSS Feed Business"].id = "26_1_4";
	wholeMenu["BBC RSS Feed Business"].color = "red";
	wholeMenu["BBC RSS Feed Business"].hasSub = 0;
	wholeMenu["BBC RSS Feed Business"].link = "news_bbc_eng.html?type=business";
	wholeMenu["BBC RSS Feed Business"].html = 'Business';

	wholeMenu["BBC RSS Feed Politics"] = {};
	wholeMenu["BBC RSS Feed Politics"].id = "26_1_5";
	wholeMenu["BBC RSS Feed Politics"].color = "red";
	wholeMenu["BBC RSS Feed Politics"].hasSub = 0;
	wholeMenu["BBC RSS Feed Politics"].link = "news_bbc_eng.html?type=politics";
	wholeMenu["BBC RSS Feed Politics"].html = 'Politics';

	wholeMenu["BBC RSS Feed Health"] = {};
	wholeMenu["BBC RSS Feed Health"].id = "26_1_6";
	wholeMenu["BBC RSS Feed Health"].color = "red";
	wholeMenu["BBC RSS Feed Health"].hasSub = 0;
	wholeMenu["BBC RSS Feed Health"].link = "news_bbc_eng.html?type=health";
	wholeMenu["BBC RSS Feed Health"].html = 'Health';

	wholeMenu["BBC RSS Feed Education"] = {};
	wholeMenu["BBC RSS Feed Education"].id = "26_1_7";
	wholeMenu["BBC RSS Feed Education"].color = "red";
	wholeMenu["BBC RSS Feed Education"].hasSub = 0;
	wholeMenu["BBC RSS Feed Education"].link = "news_bbc_eng.html?type=education";
	wholeMenu["BBC RSS Feed Education"].html = 'Education';

	wholeMenu["BBC RSS Feed Science"] = {};
	wholeMenu["BBC RSS Feed Science"].id = "26_1_8";
	wholeMenu["BBC RSS Feed Science"].color = "red";
	wholeMenu["BBC RSS Feed Science"].hasSub = 0;
	wholeMenu["BBC RSS Feed Science"].link = "news_bbc_eng.html?type=science";
	wholeMenu["BBC RSS Feed Science"].html = 'Science';

	wholeMenu["BBC RSS Feed Technology"] = {};
	wholeMenu["BBC RSS Feed Technology"].id = "26_1_9";
	wholeMenu["BBC RSS Feed Technology"].color = "red";
	wholeMenu["BBC RSS Feed Technology"].hasSub = 0;
	wholeMenu["BBC RSS Feed Technology"].link = "news_bbc_eng.html?type=technology";
	wholeMenu["BBC RSS Feed Technology"].html = 'Technology';

	wholeMenu["BBC RSS Feed Entertainment"] = {};
	wholeMenu["BBC RSS Feed Entertainment"].id = "26_1_10";
	wholeMenu["BBC RSS Feed Entertainment"].color = "red";
	wholeMenu["BBC RSS Feed Entertainment"].hasSub = 0;
	wholeMenu["BBC RSS Feed Entertainment"].link = "news_bbc_eng.html?type=entertainment";
	wholeMenu["BBC RSS Feed Entertainment"].html = 'Entertainment';

	wholeMenu["● KoreaHerald RSS Feed"] = {};
	wholeMenu["● KoreaHerald RSS Feed"].id = "26_4";
	wholeMenu["● KoreaHerald RSS Feed"].color = "red";
	wholeMenu["● KoreaHerald RSS Feed"].hasSub = 1;
	wholeMenu["● KoreaHerald RSS Feed"].link = "";
	wholeMenu["● KoreaHerald RSS Feed"].html = '&#9679; KoreaHerald RSS Feed';

	wholeMenu["KoreaHerald RSS Feed All Stories"] = {};
	wholeMenu["KoreaHerald RSS Feed All Stories"].id = "26_4_1";
	wholeMenu["KoreaHerald RSS Feed All Stories"].color = "red";
	wholeMenu["KoreaHerald RSS Feed All Stories"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Feed All Stories"].link = "news_koreaherald_eng.html?type=all";
	wholeMenu["KoreaHerald RSS Feed All Stories"].html = 'All Stories';

	wholeMenu["KoreaHerald RSS Feed World"] = {};
	wholeMenu["KoreaHerald RSS Feed World"].id = "26_4_2";
	wholeMenu["KoreaHerald RSS Feed World"].color = "red";
	wholeMenu["KoreaHerald RSS Feed World"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Feed World"].link = "news_koreaherald_eng.html?type=world";
	wholeMenu["KoreaHerald RSS Feed World"].html = 'World';

	wholeMenu["KoreaHerald RSS Feed National"] = {};
	wholeMenu["KoreaHerald RSS Feed National"].id = "26_4_3";
	wholeMenu["KoreaHerald RSS Feed National"].color = "red";
	wholeMenu["KoreaHerald RSS Feed National"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Feed National"].link = "news_koreaherald_eng.html?type=national";
	wholeMenu["KoreaHerald RSS Feed National"].html = 'National';

	wholeMenu["KoreaHerald RSS Feed Business"] = {};
	wholeMenu["KoreaHerald RSS Feed Business"].id = "26_4_4";
	wholeMenu["KoreaHerald RSS Feed Business"].color = "red";
	wholeMenu["KoreaHerald RSS Feed Business"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Feed Business"].link = "news_koreaherald_eng.html?type=business";
	wholeMenu["KoreaHerald RSS Feed Business"].html = 'Business';

	wholeMenu["KoreaHerald RSS Feed Life&Culture"] = {};
	wholeMenu["KoreaHerald RSS Feed Life&Culture"].id = "26_4_5";
	wholeMenu["KoreaHerald RSS Feed Life&Culture"].color = "red";
	wholeMenu["KoreaHerald RSS Feed Life&Culture"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Feed Life&Culture"].link = "news_koreaherald_eng.html?type=life";
	...
	wholeMenu["KoreaHerald RSS Feed Sports"].html = 'Sports';

	wholeMenu["KoreaHerald RSS Feed Opinion"] = {};
	wholeMenu["KoreaHerald RSS Feed Opinion"].id = "26_4_7";
	wholeMenu["KoreaHerald RSS Feed Opinion"].color = "red";
	wholeMenu["KoreaHerald RSS Feed Opinion"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Feed Opinion"].link = "news_koreaherald_eng.html?type=opinion";
	wholeMenu["KoreaHerald RSS Feed Opinion"].html = 'Opinion';

	wholeMenu["KoreaHerald RSS Feed K-pop"] = {};
	wholeMenu["KoreaHerald RSS Feed K-pop"].id = "26_4_8";
	wholeMenu["KoreaHerald RSS Feed K-pop"].color = "red";
	wholeMenu["KoreaHerald RSS Feed K-pop"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Feed K-pop"].link = "news_koreaherald_eng.html?type=kpop";
	wholeMenu["KoreaHerald RSS Feed K-pop"].html = 'K-pop';
	...
	wholeMenu["NASA RSS Feed Releases"].link = "news_nasa_eng.html?type=releases";
	...
	wholeMenu["NASA RSS Feed Recent"].link = "news_nasa_eng.html?type=recent";
	...
	wholeMenu["NASA RSS Feed Image"].link = "news_nasa_eng.html?type=image";
	...
	wholeMenu["NASA RSS Feed Technology"].link = "news_nasa_eng.html?type=technology";
	...
	wholeMenu["NASA RSS Feed Aeronautics"].link = "news_nasa_eng.html?type=aeronautics";
	...
	wholeMenu["NASA RSS Feed ISS"].link = "news_nasa_eng.html?type=iss";
	...
	wholeMenu["NASA RSS Feed Artemis"].link = "news_nasa_eng.html?type=artemis";
	...
	wholeMenu["NASA RSS Feed Picture"].link = "news_nasa_eng.html?type=picture";
	wholeMenu["NASA RSS Feed Picture"].html = 'Picture of the Day';

	wholeMenu["● Yahoo RSS Feed"] = {};
	wholeMenu["● Yahoo RSS Feed"].id = "26_3";
...
if (lang=="rus") {
	...
	wholeMenu["● BBC RSS Строка"].hasSub = 1;
	wholeMenu["● BBC RSS Строка"].link = "";
	wholeMenu["● BBC RSS Строка"].html = '&#9679; BBC RSS Строка';

	wholeMenu["BBC RSS Строка Top"] = {};
	wholeMenu["BBC RSS Строка Top"].id = "26_1_1";
	wholeMenu["BBC RSS Строка Top"].color = "red";
	wholeMenu["BBC RSS Строка Top"].hasSub = 0;
	wholeMenu["BBC RSS Строка Top"].link = "news_bbc_rus.html?type=top";
	wholeMenu["BBC RSS Строка Top"].html = 'Top';

	wholeMenu["BBC RSS Строка World"] = {};
	wholeMenu["BBC RSS Строка World"].id = "26_1_2";
	wholeMenu["BBC RSS Строка World"].color = "red";
	wholeMenu["BBC RSS Строка World"].hasSub = 0;
	wholeMenu["BBC RSS Строка World"].link = "news_bbc_rus.html?type=world";
	wholeMenu["BBC RSS Строка World"].html = 'World';

	wholeMenu["BBC RSS Строка UK"] = {};
	wholeMenu["BBC RSS Строка UK"].id = "26_1_3";
	wholeMenu["BBC RSS Строка UK"].color = "red";
	wholeMenu["BBC RSS Строка UK"].hasSub = 0;
	wholeMenu["BBC RSS Строка UK"].link = "news_bbc_rus.html?type=uk";
	wholeMenu["BBC RSS Строка UK"].html = 'UK';

	wholeMenu["BBC RSS Строка Business"] = {};
	wholeMenu["BBC RSS Строка Business"].id = "26_1_4";
	wholeMenu["BBC RSS Строка Business"].color = "red";
	wholeMenu["BBC RSS Строка Business"].hasSub = 0;
	wholeMenu["BBC RSS Строка Business"].link = "news_bbc_rus.html?type=business";
	wholeMenu["BBC RSS Строка Business"].html = 'Business';

	wholeMenu["BBC RSS Строка Politics"] = {};
	wholeMenu["BBC RSS Строка Politics"].id = "26_1_5";
	wholeMenu["BBC RSS Строка Politics"].color = "red";
	wholeMenu["BBC RSS Строка Politics"].hasSub = 0;
	wholeMenu["BBC RSS Строка Politics"].link = "news_bbc_rus.html?type=politics";
	wholeMenu["BBC RSS Строка Politics"].html = 'Politics';

	wholeMenu["BBC RSS Строка Health"] = {};
	wholeMenu["BBC RSS Строка Health"].id = "26_1_6";
	wholeMenu["BBC RSS Строка Health"].color = "red";
	wholeMenu["BBC RSS Строка Health"].hasSub = 0;
	wholeMenu["BBC RSS Строка Health"].link = "news_bbc_rus.html?type=health";
	wholeMenu["BBC RSS Строка Health"].html = 'Health';

	wholeMenu["BBC RSS Строка Education"] = {};
	wholeMenu["BBC RSS Строка Education"].id = "26_1_7";
	wholeMenu["BBC RSS Строка Education"].color = "red";
	wholeMenu["BBC RSS Строка Education"].hasSub = 0;
	wholeMenu["BBC RSS Строка Education"].link = "news_bbc_rus.html?type=education";
	wholeMenu["BBC RSS Строка Education"].html = 'Education';

	wholeMenu["BBC RSS Строка Science"] = {};
	wholeMenu["BBC RSS Строка Science"].id = "26_1_8";
	wholeMenu["BBC RSS Строка Science"].color = "red";
	wholeMenu["BBC RSS Строка Science"].hasSub = 0;
	wholeMenu["BBC RSS Строка Science"].link = "news_bbc_rus.html?type=science";
	wholeMenu["BBC RSS Строка Science"].html = 'Science';

	wholeMenu["BBC RSS Строка Technology"] = {};
	wholeMenu["BBC RSS Строка Technology"].id = "26_1_9";
	wholeMenu["BBC RSS Строка Technology"].color = "red";
	wholeMenu["BBC RSS Строка Technology"].hasSub = 0;
	wholeMenu["BBC RSS Строка Technology"].link = "news_bbc_rus.html?type=technology";
	wholeMenu["BBC RSS Строка Technology"].html = 'Technology';

	wholeMenu["BBC RSS Строка Entertainment"] = {};
	wholeMenu["BBC RSS Строка Entertainment"].id = "26_1_10";
	wholeMenu["BBC RSS Строка Entertainment"].color = "red";
	...
	wholeMenu["● KoreaHerald RSS Строка"] = {};
	wholeMenu["● KoreaHerald RSS Строка"].id = "26_4";
	wholeMenu["● KoreaHerald RSS Строка"].color = "red";
	wholeMenu["● KoreaHerald RSS Строка"].hasSub = 1;
	wholeMenu["● KoreaHerald RSS Строка"].link = "";
	wholeMenu["● KoreaHerald RSS Строка"].html = '&#9679; KoreaHerald RSS Строка';

	wholeMenu["KoreaHerald RSS Строка All Stories"] = {};
	wholeMenu["KoreaHerald RSS Строка All Stories"].id = "26_4_1";
	wholeMenu["KoreaHerald RSS Строка All Stories"].color = "red";
	wholeMenu["KoreaHerald RSS Строка All Stories"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Строка All Stories"].link = "news_koreaherald_rus.html?type=all";
	wholeMenu["KoreaHerald RSS Строка All Stories"].html = 'All Stories';

	wholeMenu["KoreaHerald RSS Строка World"] = {};
	wholeMenu["KoreaHerald RSS Строка World"].id = "26_4_2";
	wholeMenu["KoreaHerald RSS Строка World"].color = "red";
	wholeMenu["KoreaHerald RSS Строка World"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Строка World"].link = "news_koreaherald_rus.html?type=world";
	wholeMenu["KoreaHerald RSS Строка World"].html = 'World';

	wholeMenu["KoreaHerald RSS Строка National"] = {};
	wholeMenu["KoreaHerald RSS Строка National"].id = "26_4_3";
	wholeMenu["KoreaHerald RSS Строка National"].color = "red";
	wholeMenu["KoreaHerald RSS Строка National"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Строка National"].link = "news_koreaherald_rus.html?type=national";
	wholeMenu["KoreaHerald RSS Строка National"].html = 'National';

	wholeMenu["KoreaHerald RSS Строка Business"] = {};
	wholeMenu["KoreaHerald RSS Строка Business"].id = "26_4_4";
	wholeMenu["KoreaHerald RSS Строка Business"].color = "red";
	wholeMenu["KoreaHerald RSS Строка Business"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Строка Business"].link = "news_koreaherald_rus.html?type=business";
	wholeMenu["KoreaHerald RSS Строка Business"].html = 'Business';

	wholeMenu["KoreaHerald RSS Строка Life&Culture"] = {};
	wholeMenu["KoreaHerald RSS Строка Life&Culture"].id = "26_4_5";
	wholeMenu["KoreaHerald RSS Строка Life&Culture"].color = "red";
	wholeMenu["KoreaHerald RSS Строка Life&Culture"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Строка Life&Culture"].link = "news_koreaherald_rus.html?type=life";
	...
	wholeMenu["KoreaHerald RSS Строка Sports"].html = 'Sports';

	wholeMenu["KoreaHerald RSS Строка Opinion"] = {};
	wholeMenu["KoreaHerald RSS Строка Opinion"].id = "26_4_7";
	wholeMenu["KoreaHerald RSS Строка Opinion"].color = "red";
	wholeMenu["KoreaHerald RSS Строка Opinion"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Строка Opinion"].link = "news_koreaherald_rus.html?type=opinion";
	wholeMenu["KoreaHerald RSS Строка Opinion"].html = 'Opinion';

	wholeMenu["KoreaHerald RSS Строка K-pop"] = {};
	wholeMenu["KoreaHerald RSS Строка K-pop"].id = "26_4_8";
	wholeMenu["KoreaHerald RSS Строка K-pop"].color = "red";
	wholeMenu["KoreaHerald RSS Строка K-pop"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Строка K-pop"].link = "news_koreaherald_rus.html?type=kpop";
	wholeMenu["KoreaHerald RSS Строка K-pop"].html = 'K-pop';
	...
	wholeMenu["NASA RSS Строка Releases"].link = "news_nasa_rus.html?type=releases";
	...
	wholeMenu["NASA RSS Строка Recent"].link = "news_nasa_rus.html?type=recent";
	...
	wholeMenu["NASA RSS Строка Image"].link = "news_nasa_rus.html?type=image";
	...
	wholeMenu["NASA RSS Строка Technology"].link = "news_nasa_rus.html?type=technology";
	...
	wholeMenu["NASA RSS Строка Aeronautics"].link = "news_nasa_rus.html?type=aeronautics";
	...
	wholeMenu["NASA RSS Строка ISS"].link = "news_nasa_rus.html?type=iss";
	...
	wholeMenu["NASA RSS Строка Artemis"].link = "news_nasa_rus.html?type=artemis";
	...
	wholeMenu["NASA RSS Строка Picture"].link = "news_nasa_rus.html?type=picture";
	wholeMenu["NASA RSS Строка Picture"].html = 'Picture of the Day';

	wholeMenu["● Yahoo RSS Строка"] = {};
	wholeMenu["● Yahoo RSS Строка"].id = "26_3";
...
if (lang=="lat") {
	...
	wholeMenu["● BBC RSS Acies"].hasSub = 1;
	wholeMenu["● BBC RSS Acies"].link = "";
	wholeMenu["● BBC RSS Acies"].html = '&#9679; BBC RSS Acies';

	wholeMenu["BBC RSS Acies Top"] = {};
	wholeMenu["BBC RSS Acies Top"].id = "26_1_1";
	wholeMenu["BBC RSS Acies Top"].color = "red";
	wholeMenu["BBC RSS Acies Top"].hasSub = 0;
	wholeMenu["BBC RSS Acies Top"].link = "news_bbc_lat.html?type=top";
	wholeMenu["BBC RSS Acies Top"].html = 'Top';

	wholeMenu["BBC RSS Acies World"] = {};
	wholeMenu["BBC RSS Acies World"].id = "26_1_2";
	wholeMenu["BBC RSS Acies World"].color = "red";
	wholeMenu["BBC RSS Acies World"].hasSub = 0;
	wholeMenu["BBC RSS Acies World"].link = "news_bbc_lat.html?type=world";
	wholeMenu["BBC RSS Acies World"].html = 'World';

	wholeMenu["BBC RSS Acies UK"] = {};
	wholeMenu["BBC RSS Acies UK"].id = "26_1_3";
	wholeMenu["BBC RSS Acies UK"].color = "red";
	wholeMenu["BBC RSS Acies UK"].hasSub = 0;
	wholeMenu["BBC RSS Acies UK"].link = "news_bbc_lat.html?type=uk";
	wholeMenu["BBC RSS Acies UK"].html = 'UK';

	wholeMenu["BBC RSS Acies Business"] = {};
	wholeMenu["BBC RSS Acies Business"].id = "26_1_4";
	wholeMenu["BBC RSS Acies Business"].color = "red";
	wholeMenu["BBC RSS Acies Business"].hasSub = 0;
	wholeMenu["BBC RSS Acies Business"].link = "news_bbc_lat.html?type=business";
	wholeMenu["BBC RSS Acies Business"].html = 'Business';

	wholeMenu["BBC RSS Acies Politics"] = {};
	wholeMenu["BBC RSS Acies Politics"].id = "26_1_5";
	wholeMenu["BBC RSS Acies Politics"].color = "red";
	wholeMenu["BBC RSS Acies Politics"].hasSub = 0;
	wholeMenu["BBC RSS Acies Politics"].link = "news_bbc_lat.html?type=politics";
	wholeMenu["BBC RSS Acies Politics"].html = 'Politics';

	wholeMenu["BBC RSS Acies Health"] = {};
	wholeMenu["BBC RSS Acies Health"].id = "26_1_6";
	wholeMenu["BBC RSS Acies Health"].color = "red";
	wholeMenu["BBC RSS Acies Health"].hasSub = 0;
	wholeMenu["BBC RSS Acies Health"].link = "news_bbc_lat.html?type=health";
	wholeMenu["BBC RSS Acies Health"].html = 'Health';

	wholeMenu["BBC RSS Acies Education"] = {};
	wholeMenu["BBC RSS Acies Education"].id = "26_1_7";
	wholeMenu["BBC RSS Acies Education"].color = "red";
	wholeMenu["BBC RSS Acies Education"].hasSub = 0;
	wholeMenu["BBC RSS Acies Education"].link = "news_bbc_lat.html?type=education";
	wholeMenu["BBC RSS Acies Education"].html = 'Education';

	wholeMenu["BBC RSS Acies Science"] = {};
	wholeMenu["BBC RSS Acies Science"].id = "26_1_8";
	wholeMenu["BBC RSS Acies Science"].color = "red";
	wholeMenu["BBC RSS Acies Science"].hasSub = 0;
	wholeMenu["BBC RSS Acies Science"].link = "news_bbc_lat.html?type=science";
	wholeMenu["BBC RSS Acies Science"].html = 'Science';

	wholeMenu["BBC RSS Acies Technology"] = {};
	wholeMenu["BBC RSS Acies Technology"].id = "26_1_9";
	wholeMenu["BBC RSS Acies Technology"].color = "red";
	wholeMenu["BBC RSS Acies Technology"].hasSub = 0;
	wholeMenu["BBC RSS Acies Technology"].link = "news_bbc_lat.html?type=technology";
	wholeMenu["BBC RSS Acies Technology"].html = 'Technology';

	wholeMenu["BBC RSS Acies Entertainment"] = {};
	wholeMenu["BBC RSS Acies Entertainment"].id = "26_1_10";
	wholeMenu["BBC RSS Acies Entertainment"].color = "red";
	...
	wholeMenu["● KoreaHerald RSS Acies"] = {};
	wholeMenu["● KoreaHerald RSS Acies"].id = "26_4";
	wholeMenu["● KoreaHerald RSS Acies"].color = "red";
	wholeMenu["● KoreaHerald RSS Acies"].hasSub = 1;
	wholeMenu["● KoreaHerald RSS Acies"].link = "";
	wholeMenu["● KoreaHerald RSS Acies"].html = '&#9679; KoreaHerald RSS Acies';

	wholeMenu["KoreaHerald RSS Acies All Stories"] = {};
	wholeMenu["KoreaHerald RSS Acies All Stories"].id = "26_4_1";
	wholeMenu["KoreaHerald RSS Acies All Stories"].color = "red";
	wholeMenu["KoreaHerald RSS Acies All Stories"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Acies All Stories"].link = "news_koreaherald_lat.html?type=all";
	wholeMenu["KoreaHerald RSS Acies All Stories"].html = 'All Stories';

	wholeMenu["KoreaHerald RSS Acies World"] = {};
	wholeMenu["KoreaHerald RSS Acies World"].id = "26_4_2";
	wholeMenu["KoreaHerald RSS Acies World"].color = "red";
	wholeMenu["KoreaHerald RSS Acies World"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Acies World"].link = "news_koreaherald_lat.html?type=world";
	wholeMenu["KoreaHerald RSS Acies World"].html = 'World';

	wholeMenu["KoreaHerald RSS Acies National"] = {};
	wholeMenu["KoreaHerald RSS Acies National"].id = "26_4_3";
	wholeMenu["KoreaHerald RSS Acies National"].color = "red";
	wholeMenu["KoreaHerald RSS Acies National"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Acies National"].link = "news_koreaherald_lat.html?type=national";
	wholeMenu["KoreaHerald RSS Acies National"].html = 'National';

	wholeMenu["KoreaHerald RSS Acies Business"] = {};
	wholeMenu["KoreaHerald RSS Acies Business"].id = "26_4_4";
	wholeMenu["KoreaHerald RSS Acies Business"].color = "red";
	wholeMenu["KoreaHerald RSS Acies Business"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Acies Business"].link = "news_koreaherald_lat.html?type=business";
	wholeMenu["KoreaHerald RSS Acies Business"].html = 'Business';

	wholeMenu["KoreaHerald RSS Acies Life&Culture"] = {};
	wholeMenu["KoreaHerald RSS Acies Life&Culture"].id = "26_4_5";
	wholeMenu["KoreaHerald RSS Acies Life&Culture"].color = "red";
	wholeMenu["KoreaHerald RSS Acies Life&Culture"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Acies Life&Culture"].link = "news_koreaherald_lat.html?type=life";
	...
	wholeMenu["KoreaHerald RSS Acies Sports"].html = 'Sports';

	wholeMenu["KoreaHerald RSS Acies Opinion"] = {};
	wholeMenu["KoreaHerald RSS Acies Opinion"].id = "26_4_7";
	wholeMenu["KoreaHerald RSS Acies Opinion"].color = "red";
	wholeMenu["KoreaHerald RSS Acies Opinion"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Acies Opinion"].link = "news_koreaherald_lat.html?type=opinion";
	wholeMenu["KoreaHerald RSS Acies Opinion"].html = 'Opinion';

	wholeMenu["KoreaHerald RSS Acies K-pop"] = {};
	wholeMenu["KoreaHerald RSS Acies K-pop"].id = "26_4_8";
	wholeMenu["KoreaHerald RSS Acies K-pop"].color = "red";
	wholeMenu["KoreaHerald RSS Acies K-pop"].hasSub = 0;
	wholeMenu["KoreaHerald RSS Acies K-pop"].link = "news_koreaherald_lat.html?type=kpop";
	wholeMenu["KoreaHerald RSS Acies K-pop"].html = 'K-pop';
	...
	wholeMenu["NASA RSS Acies Releases"].link = "news_nasa_lat.html?type=releases";
	...
	wholeMenu["NASA RSS Acies Recent"].link = "news_nasa_lat.html?type=recent";
	...
	wholeMenu["NASA RSS Acies Image"].link = "news_nasa_lat.html?type=image";
	...
	wholeMenu["NASA RSS Acies Technology"].link = "news_nasa_lat.html?type=technology";
	...
	wholeMenu["NASA RSS Acies Aeronautics"].link = "news_nasa_lat.html?type=aeronautics";
	...
	wholeMenu["NASA RSS Acies ISS"].link = "news_nasa_lat.html?type=iss";
	...
	wholeMenu["NASA RSS Acies Artemis"].link = "news_nasa_lat.html?type=artemis";
	...
	wholeMenu["NASA RSS Acies Picture"].link = "news_nasa_lat.html?type=picture";
	wholeMenu["NASA RSS Acies Picture"].html = 'Picture of the Day';

	wholeMenu["● Yahoo RSS Acies"] = {};
	wholeMenu["● Yahoo RSS Acies"].id = "26_3";
