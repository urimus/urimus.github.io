...
function refreshContentsTabs(contentsTypeL) {
	...
	if (contentsType=="junk" || contentsTypeL=="junk") mouseOut('junk', contentsTypeL, 'black');
...
// ------------- used for small text and sort by date, flag  ----------- //
	...
	if (type=="music" || type=="movies" || type=="series" || type=="games" || type=="amv" || type=="junk" || type=="stuff") textColor="black_blue";
...
// ------------- Showing Feed Image ----------- //
			...
			aSkip.setAttribute('class', 'standardb_'+textColor.split("_")[0]);
